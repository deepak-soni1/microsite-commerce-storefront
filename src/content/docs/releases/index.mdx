...
- **Commerce Storefront B2B compatibility**: Improved integration and compatibility with storefront-builder tools including Adobe Commerce B2B modules
...
| Adobe Commerce B2B Package | Storefront Compatibility B2B Package |
|----------------------------|--------------------------------------|
| `1.5.2`                    | `1.0.8`                              |
...
| Storefront Compatibility Package (SCP) | • Secure [personalization](/merchants/commerce-blocks/personalization/) features<br/>• Social login integration APIs |
